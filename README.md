...
# Short Overview
Task Tracker is a lightweight Flask web app that helps students/users track tasks in one place. It focuses on core productivity features (view, add, complete, delete tasks) without accounts, databases, or heavy styling.
